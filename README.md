...
- copie permanente des dernières métadonnées associée à chaque vidéo, conservée après publication ou suppression d’une programmation ;
- préremplissage automatique des nouvelles programmations et bouton pour restaurer les métadonnées conservées ;
